...
from analysis2.cache import CacheStore, cache_key
...
from analysis2.eventcalc_proposals import _proposal_identity
...
class EventCalcAdapterTests(unittest.TestCase):
    ...
    def test_selection_change_reuses_proposal_identity_but_splits_weighted_cache(self):
        ...
        with patch(
            "analysis2.eventcalc_adapter.generate_mother_sample",
