...
from alp_discrimination.config import PRODUCTION_MASSES_GEV, PROFILES, get_config
...
from alp_discrimination.workflows import float_token, require_columns, write_dataframe, write_manifest
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Use every mass in alp_discrimination.config.PRODUCTION_MASSES_GEV.",
    )
    parser.add_argument(
        "--all-common-masses",
        action="store_true",
