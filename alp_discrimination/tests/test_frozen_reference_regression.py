...
from alp_discrimination.distance_statistics import total_variation_matrix
from alp_discrimination.eventcalc_adapter import _proposal_identity
from alp_discrimination.frozen_reference import (
    ENDPOINTS,
...
from alp_discrimination.templates import (
