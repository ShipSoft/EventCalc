...
from alp_discrimination.frozen_regression import RegressionMismatchError, RegressionPaths
from alp_discrimination.workflows.compare_frozen_results import (
    parse_arguments,
    resolve_paths,
    run_workflow,
...
class CompareFrozenResultsWorkflowTests(unittest.TestCase):
    ...
    def test_output_paths_are_portable_and_mismatch_is_written_before_raise(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "alp_discrimination.workflows.compare_frozen_results.compare_frozen_outputs",
                return_value=report,
            ):
