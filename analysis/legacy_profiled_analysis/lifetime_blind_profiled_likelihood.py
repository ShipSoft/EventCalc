"""Run lifetime-profiled shape-only pseudoexperiments for the frozen-reference ALP study.
...
def _bank_helpers() -> tuple[Callable, Callable]:
    ...
    try:
        from analysis.legacy_profiled_analysis.lifetime_blind_distance_maps import (
            load_template_bank,
            select_bank_paths,
        )
    except ModuleNotFoundError as error:
        raise ModuleNotFoundError(
            "Could not import analysis.legacy_profiled_analysis.lifetime_blind_distance_maps. "
